...
const BOOKS = [
    ...
    { id: 6, title: 'Height3', src: 'img/book-cover.png', author: 'Del', description: 'Any story', keywords:'height', rating:5, price:0,created_at:new Date(2022,10,25)},
    { id: 7, title: 'Height2022', src: 'img/book-cover.png', author: 'Del', description: 'Any story', keywords:'height', rating:5, price:0,created_at:new Date(2022,10,25)}
];
